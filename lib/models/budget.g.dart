...
const BudgetSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'categoryWiseAmount': PropertySchema(
      id: 1,
      name: r'categoryWiseAmount',
      type: IsarType.objectList,
      target: r'CategoryWiseAmount',
    ),
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'CategoryWiseAmount': CategoryWiseAmountSchema},
  getId: _budgetGetId,
...
int _budgetEstimateSize(
  ...
  bytesCount += 3 + object.categoryWiseAmount.length * 3;
  {
    final offsets = allOffsets[CategoryWiseAmount]!;
    for (var i = 0; i < object.categoryWiseAmount.length; i++) {
      final value = object.categoryWiseAmount[i];
      bytesCount +=
          CategoryWiseAmountSchema.estimateSize(value, offsets, allOffsets);
    }
  }
  return bytesCount;
}
...
void _budgetSerialize(
  ...
  writer.writeObjectList<CategoryWiseAmount>(
    offsets[1],
    allOffsets,
    CategoryWiseAmountSchema.serialize,
    object.categoryWiseAmount,
  );
...
Budget _budgetDeserialize(
  ...
  object.categoryWiseAmount = reader.readObjectList<CategoryWiseAmount>(
        offsets[1],
        CategoryWiseAmountSchema.deserialize,
        allOffsets,
        CategoryWiseAmount(),
      ) ??
      [];
...
P _budgetDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readObjectList<CategoryWiseAmount>(
            offset,
            CategoryWiseAmountSchema.deserialize,
            allOffsets,
            CategoryWiseAmount(),
...
extension BudgetQueryFilter on QueryBuilder<Budget, Budget, QFilterCondition> {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition>
      categoryWiseAmountLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'categoryWiseAmount',
        length,
        true,
        length,
        true,
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition>
      categoryWiseAmountLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition>
      categoryWiseAmountLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition>
      categoryWiseAmountLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension BudgetQueryObject on QueryBuilder<Budget, Budget, QFilterCondition> {
  QueryBuilder<Budget, Budget, QAfterFilterCondition> categoryWiseAmountElement(
      FilterQuery<CategoryWiseAmount> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'categoryWiseAmount');
    });
  }
}
...
extension BudgetQueryProperty on QueryBuilder<Budget, Budget, QQueryProperty> {
  ...
  QueryBuilder<Budget, List<CategoryWiseAmount>, QQueryOperations>
      categoryWiseAmountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'categoryWiseAmount');
    });
  }
...
const CategoryWiseAmountSchema = Schema(
  name: r'CategoryWiseAmount',
  id: 6772071601838306351,
  properties: {
    r'amount': PropertySchema(
      id: 0,
      name: r'amount',
  ...
  estimateSize: _categoryWiseAmountEstimateSize,
  serialize: _categoryWiseAmountSerialize,
  deserialize: _categoryWiseAmountDeserialize,
  deserializeProp: _categoryWiseAmountDeserializeProp,
);

int _categoryWiseAmountEstimateSize(
  CategoryWiseAmount object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _categoryWiseAmountSerialize(
  CategoryWiseAmount object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
CategoryWiseAmount _categoryWiseAmountDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = CategoryWiseAmount();
  object.amount = reader.readDouble(offsets[0]);
  object.category = reader.readString(offsets[1]);
  return object;
}

P _categoryWiseAmountDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension CategoryWiseAmountQueryFilter
    on QueryBuilder<CategoryWiseAmount, CategoryWiseAmount, QFilterCondition> {
  QueryBuilder<CategoryWiseAmount, CategoryWiseAmount, QAfterFilterCondition>
      amountEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
...
extension CategoryWiseAmountQueryObject
    on QueryBuilder<CategoryWiseAmount, CategoryWiseAmount, QFilterCondition> {}
